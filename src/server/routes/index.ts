...
router.get('/cidades/:id', CidadesController.getByIdlValidation, CidadesController.getById)
...
router.get('/pessoas/:id', PessoasController.getByIdlValidation, PessoasController.getById)
